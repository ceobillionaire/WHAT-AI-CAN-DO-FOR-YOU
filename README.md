...
### 2.1 Learn How to Build State of the Art Models 

**[1]** Video + `CODE` ["**_Practical Deep Learning For Coders, Part 1_**"](http://course.fast.ai) by Jeremy Howard.

### 2.2 Data Science IPython Notebooks

**[2]** `CODE` ["**_Data Science Python Notebooks: Deep learning (TensorFlow, Theano, Caffe), Scikit-learn, Kaggle, Big Data (Spark, Hadoop MapReduce, HDFS), Pandas, NumPy, SciPy..._**"](https://github.com/donnemartin/data-science-ipython-notebooks)
